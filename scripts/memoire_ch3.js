...
function buildChapter3(h) {
  ...
  return [
    ...
    P_body("La conception proposée dans ce chapitre pose les fondations nécessaires au développement effectif de la plateforme. L'implémentation concrète, l'expérimentation sur un corpus pilote de travaux académiques de la Faculté des Sciences et l'évaluation quantitative des performances constitueront l'étape suivante du projet, postérieure au présent travail de conception. Les choix techniques opérés ici (Sentence-BERT multilingue, pgvector, FastAPI, React, Docker) ouvrent une feuille de route claire pour cette phase de développement, en s'appuyant sur des technologies open source maîtrisables dans le contexte congolais."),
