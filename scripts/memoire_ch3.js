...
function buildChapter3(h) {
  ...
  return [
    ...
    H2("III.7. Pipeline de traitement IA"),
    ...
    H3("III.7.1. Soumission du document"),
    ...
    H3("III.7.2. Extraction du texte"),
    ...
    H3("III.7.4. Génération des embeddings"),
    ...
    H3("III.7.5. Recherche vectorielle"),
    ...
    H3("III.7.6. Calcul de similarité"),
    ...
    H3("III.7.7. Détection et classification"),
    ...
    H3("III.7.8. Génération du rapport"),
    ...
    H2("III.8. Base documentaire relationnelle"),
    ...
    H2("III.10. Conception de l'API REST"),
    ...
    ...threeLineTable(
      ...
      "Tableau III.3 — Principaux endpoints de l'API REST"
    ),
    ...
    H2("III.11. Modélisation UML"),
    H3("III.11.1. Diagramme de cas d'utilisation"),
    ...
    H3("III.11.2. Diagramme de classes"),
    ...
    H3("III.11.3. Diagramme de séquences"),
    ...
    H2("III.12. Diagrammes d'architecture logicielle"),
