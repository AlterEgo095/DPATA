...
function buildChapter3(h) {
  ...
  return [
    ...
    H2("III.2. Présentation du cadre : la Faculté des Sciences et Technologies"),
    ...
    H2("III.13. Module de recommandation de sujets de mémoire"),
