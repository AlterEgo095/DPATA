...
function buildChapter3(h) {
  ...
  return [
    ...
    P_body("Au-delà de la modularité fonctionnelle, la plateforme est conçue selon une architecture multicouche hiérarchique qui reflète la structure organisationnelle de l'université. Cette vision multicouche est essentielle pour comprendre le potentiel d'extension de la plateforme à l'échelle institutionnelle et nationale. Chaque couche correspond à un niveau d'organisation académique et bénéficie d'un niveau d'autonomie fonctionnelle, tout en s'inscrivant dans un ensemble cohérent."),
    P_centered("Figure III.1 — Architecture multicouche universitaire de la plateforme", true, 22),
    P_centered("┌─────────────────────────────────────────────┐", false, 20),
    P_centered("           UNIVERSITÉ (UNIKIN)", true, 22),
    P_centered("└───────────────────────┬─────────────────────┘", false, 20),
    P_centered("                        │", false, 20),
    P_centered("       ┌────────────────▼────────────────┐", false, 20),
    P_centered("       │   PLATEFORME CENTRALE IA (UNIKIN)  │", true, 22),
    P_centered("       │  • Gestion utilisateurs           │", false, 20),
    P_centered("       │  • Base documentaire centralisée  │", false, 20),
    P_centered("       │  • Moteur IA anti-plagiat         │", false, 20),
    P_centered("       │  • API & tableaux de bord         │", false, 20),
    P_centered("       └──┬──────────┬──────────┬─────────┘", false, 20),
    P_centered("          │          │          │", false, 20),
    P_centered("   ┌──────▼───┐ ┌────▼────┐ ┌──▼────────┐", false, 20),
    P_centered("   │ Faculté A│ │Faculté B│ │ Faculté C │", true, 22),
    P_centered("   │ Sciences │ │  Droit  │ │ Médecine  │", false, 20),
    P_centered("   └──┬───────┘ └──┬──────┘ └────┬──────┘", false, 20),
    P_centered("      │            │             │", false, 20),
    P_centered("   ┌──▼──────┐  ┌──▼─────┐  ┌───▼─────┐", false, 20),
    P_centered("   │Départem.│  │Départem│  │Départem.│", true, 22),
    P_centered("   │  Info.  │  │ Privé  │  │ Chirurg.│", false, 20),
    P_centered("   └──┬──────┘  └──┬─────┘  └───┬─────┘", false, 20),
    P_centered("      │            │             │", false, 20),
    P_centered("   ┌──▼──────┐  ┌──▼─────┐  ┌───▼─────┐", false, 20),
    P_centered("   │Étudiants│  │Étudiants│  │Étudiants│", true, 22),
    P_centered("   └──┬──────┘  └──┬─────┘  └───┬─────┘", false, 20),
    P_centered("      │            │             │", false, 20),
    P_centered("   ┌──▼────────────▼─────────────▼────┐", false, 20),
    P_centered("   │ SOUMISSION DES MÉMOIRES & TFC     │", true, 22),
    P_centered("   └───────────────┬───────────────────┘", false, 20),
    P_centered("                   │", false, 20),
    P_centered("         ┌─────────▼─────────┐", false, 20),
    P_centered("         │   MOTEUR IA        │", true, 22),
    P_centered("         │  • OCR + NLP       │", false, 20),
    P_centered("         │  • Embeddings      │", false, 20),
    P_centered("         │  • Recherche vect. │", false, 20),
    P_centered("         │  • Similarité      │", false, 20),
    P_centered("         └─────────┬─────────┘", false, 20),
    P_centered("                   │", false, 20),
    P_centered("         ┌─────────▼─────────┐", false, 20),
    P_centered("         │   RAPPORT IA       │", true, 22),
    P_centered("         └─────────┬─────────┘", false, 20),
    P_centered("                   │", false, 20),
    P_centered("         ┌─────────▼─────────┐", false, 20),
    P_centered("         │   JURY / ENSEIGNANT│", true, 22),
    P_centered("         └───────────────────┘", false, 20),
