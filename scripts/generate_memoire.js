...
function buildCover() {
  ...
  return [
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "intelligente d'aide à la détection", size: 36, bold: true, color: P.primary, font: FONT_HEAD })] }),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "du plagiat et au choix d'un sujet", size: 32, bold: true, color: P.primary, font: FONT_HEAD })] }),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 600, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "de mémoire", size: 32, bold: true, color: P.primary, font: FONT_HEAD })] }),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 800, line: 360, lineRule: "atLeast" },
      children: [new TextRun({ text: "Cas de la Faculté des Sciences et Technologies de l'Université de Kinshasa", size: 24, italics: true, color: P.secondary, font: FONT_BODY })] }),
    infoTable,
