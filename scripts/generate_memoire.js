...
function buildCover() {
  ...
  return [
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 400, after: 200, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "Développement d'une plateforme web basée", size: 36, bold: true, color: P.primary, font: FONT_HEAD })] }),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "sur l'Intelligence Artificielle pour la", size: 36, bold: true, color: P.primary, font: FONT_HEAD })] }),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 600, line: 520, lineRule: "atLeast" },
      children: [new TextRun({ text: "détection du plagiat académique", size: 36, bold: true, color: P.primary, font: FONT_HEAD })] }),
