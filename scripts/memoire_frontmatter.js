...
function buildFrontMatter(h) {
  ...
  return [
    ...
    P_body("Ce travail sanctionne la fin du deuxième cycle à l'Université de Kinshasa, plus particulièrement à la Faculté des Sciences au Département de Mathématiques et Informatique. De ce fait, qu'il nous soit permis d'exprimer notre gratitude à tous ceux qui de loin ou de près nous ont assistés tant moralement que matériellement dans l'élaboration de ce travail."),
    P_body("Nos plus grands remerciements vont à l'endroit du Professeur KASORO MULENDA Nathanaël qui a accepté de diriger ce travail depuis l'imagination de l'auteur jusqu'à la réalisation de cette œuvre avec un maximum d'attention, et cela malgré ses nombreuses occupations."),
    P_body("Nos remerciements s'adressent également à tous les professeurs de la Faculté des Sciences, en particuliers du Département de Mathématiques et Informatique, pour leurs enseignements de qualité dont nous sommes bénéficiaires aujourd'hui."),
