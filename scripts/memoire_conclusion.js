...
function buildConclusion(h) {
  ...
  return [
    ...
    P_body("Au-delà de ces axes, le présent travail s'inscrit dans une dynamique plus large de renforcement des capacités numériques locales et de contribution de la recherche africaine aux grands défis technologiques contemporains. La détection du plagiat académique n'est qu'un exemple des nombreux domaines où l'application des techniques modernes d'Intelligence Artificielle peut apporter des solutions pertinentes aux défis spécifiques du contexte congolais et africain. Le développement de solutions locales, adaptées, maîtrisées et évolutives, constitue une alternative nécessaire à la dépendance technologique extérieure, et participe à la construction d'une souveraineté numérique nationale. La plateforme PlagiatIA, opérationnelle et testée, constitue une première réalisation concrète de cette ambition, et ouvre la voie à de futurs développements au service de la communauté académique congolaise et africaine."),
